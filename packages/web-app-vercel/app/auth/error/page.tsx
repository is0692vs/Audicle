...
export default function AuthError() {
  ...
  if (error === 'AccessDenied') {
    errorDetails = 'エラーコード: AccessDenied - ユーザーが許可されたリストにありません';
    if (errorDescription) {
      try {
      ...
      <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-lg shadow">
        <div className="text-center">
          ...
          <div className="mt-8 pt-8 border-t border-gray-300">
            <h3 className="text-sm font-semibold text-gray-700 mb-4">🔍 デバッグ情報</h3>
            <div className="bg-gray-100 p-4 rounded text-left text-xs space-y-2">
              ...
              <div>
                <p className="text-gray-600">
                  <strong>タイムスタンプ:</strong> {new Date().toLocaleString('ja-JP')}
                </p>
              </div>
            </div>
          </div>
